...
$(U)1.opc: $(U)1.c tunistd.h tty_public.h intqueue/intqueue.h 
	$(PC_CC) $(PC_CFLAGS) -I$(PC_INC) -c -o $(U)1.opc $(U)1.c

$(U)2.opc: $(U)2.c tunistd.h tty_public.h intqueue/intqueue.h 
	$(PC_CC) $(PC_CFLAGS) -I$(PC_INC) -c -o $(U)2.opc $(U)2.c

$(U)3.opc: $(U)3.c tunistd.h tty_public.h intqueue/intqueue.h 
...
ioconf.opc: ioconf.c ioconf.h tty.h debuglog.h
...
debuglog.opc: debuglog.c debuglog.h tsystm.h
...
timer.opc: timer.c ttimer.h debuglog.h
...
intqueue.opc: intqueue/intqueue.c  intqueue/intqueue.h
	$(PC_CC) $(PC_CFLAGS) -I$(PC_INC) -c -o intqueue.opc intqueue/intqueue.c
